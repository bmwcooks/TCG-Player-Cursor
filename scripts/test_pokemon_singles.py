...
def test_xy_era():
    ...
    assert_include("xy", "Lysandre (104 Full Art)", "Ultra Rare", "104/106", expected=False)
...
def test_sm_era():
    ...
    assert_include("sun-and-moon", "Jessie & James (Full Art)", "Ultra Rare", "68/68", expected=False)
    assert_include("sun-and-moon", "Cynthia (Full Art)", "Ultra Rare", "148/156", expected=False)
